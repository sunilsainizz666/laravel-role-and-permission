...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `description`, `role_id`, `profile_image`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Sunil saini', 'sunilsaini@gmail.com', '1234567890', 'User description here', 1, 'profile1.jpg', NULL, '$2y$10$/WuShlzx6A2xlSdg521Uj./pHpEGB04rB/toeltFTQQnFsR6MY/eG', NULL, '2020-07-25 10:43:33', '2020-07-25 10:43:33'),
(3, 'test2', 'admin@akijfood.com', '0987654321', 'Admin description here', 2, 'profile2.jpg', NULL, '$2y$10$/4YK7i2fVqdTfm0WAJM3lOnApbJx4w9vxUBZyjN3HqBTnV0zmcwO.', NULL, '2020-08-14 02:28:22', '2020-08-14 03:07:31');
